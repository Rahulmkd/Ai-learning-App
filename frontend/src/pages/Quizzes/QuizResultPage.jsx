...
const QuizResultPage = () => {
  ...
  const getScoreColor = (score) => {
    if (score >= 80) return "from-indigo-500 to-purple-500";
  ...
  return (
    <div className="max-w-5xl mx-auto">
      ...
      <PageHeader title={`${quiz.document.title || "Quiz"} Results`} />
      ...
      <div className="bg-white/80 backdrop-blur-xl border-2 border-slate-200 rounded-2xl shadow-xl shadow-slate-200/50 p-8 mb-8">
        <div className="text-center space-y-6">
          <div className="inline-flex items-center justify-center w-15 h-15 rounded-2xl bg-linear-to-br from-indigo-100 to-purple-100 shadow-lg shadow-indigo-500/25 ">
