...
const QuizTakePage = () => {
  ...
  const handleSubmitQuiz = async () => {
    ...
    try {
      ...
      toast.success("Quiz submitting successsfully!");
    ...
    <div className="max-w-4xl mx-auto">
      ...
      <div className="mb-6">
        ...
        <div className="bg-white/80 backdrop-blur-xl border-2 border-slate-200 rounded-2xl shadow-xl shadow-slate-200/50 p-6 mb-8">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-linear-to-r from-indigo-50 to-purple-50 border border-indigo-200 rounded-xl mb-6">
              ...
              return (
                <label
                  ...
                  className={`group relative flex items-center p-3 border-2 rounded-xl cursor-pointer transition-all duration-200 ${
                    isSelected
                      ? "border-indigo-500 bg-indigo-50 shadow-lg shadow-indigo-500/0"
                ...
                >
                  ...
                  <div
                    className={`shrink-0 w-5 h-5 rounded-full border-2 transition-all duration-200 ${
                      isSelected
                        ? "border-indigo-50 bg-indigo-500"
          ...
          return (
            <button
              ...
              className={`w-8 h-8 rounded-lg font-semibold text-xs transition-all duration-200 ${
                isCurrent
                  ? "bg-linear-to-r from-indigo-500 to-purple-500 text-white shadow-lg shadow-indigo-500/25 scale-110"
                  : isAnsweredQuestion
